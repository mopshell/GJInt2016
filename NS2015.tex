...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.5\textwidth]{fig/panel_multisrcrec.eps}
...
%\begin{figure}[!ht]
%	\centering
%	\includegraphics[width=0.5\textwidth]{fig/piezo-source-validation.eps}
...
%\begin{figure}[!h]
%	\centering
%	\includegraphics[width=0.5\textwidth]{fig/trans2d3d-musc.eps}
...
%\begin{figure}[!h]
%	\centering
%	\includegraphics[width=0.5\textwidth]{fig/srccomp.eps}
