...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.4]{fig/reproducibility_acqui_principle.eps}
	\caption{.}
	\label{amplitude_acqui_principle}
\end{figure}
